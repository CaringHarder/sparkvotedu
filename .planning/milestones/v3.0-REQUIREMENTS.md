# Requirements Archive: v3.0 Student Join Overhaul + Cleanup
...
- [x] **TCHR-04**: Student can edit their own display name via gear icon in session header (emoji editing intentionally excluded — emoji is set once during join/migration only)
...
| TCHR-02 | Phase 44 → 45 | Complete (persistence closed in Phase 45) |
