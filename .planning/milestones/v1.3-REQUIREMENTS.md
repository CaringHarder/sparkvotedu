# Requirements Archive: v1.3 Bug Fixes & UX Parity
...
- [x] **FIX-03**: Student dashboard dynamically removes deleted brackets and polls without requiring a page refresh
